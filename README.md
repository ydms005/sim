...
**Q. AI(Claude·ChatGPT)에서 대학 정보를 찾아보고 싶어요.**
`/ai` 화면에서 안내합니다. Supabase 에 `mcp` Edge Function 을 배포하면(자세한 방법은 [`supabase/README.md`](supabase/README.md#ai-연동-mcp-서버-mcp))
로그인 없이 누구나 Claude·ChatGPT 채팅에서 이 사이트의 대학 정보를 물어볼 수 있습니다.
